...
Cmd.prototype.newApp = function() {
  ...
  .action(function(name, options) {
    if (name === undefined) {
      ...
      console.log("e.g workshops new MyApp".green);
      console.log("e.g workshops new --help for more information".green);
      process.exit(code);
    }
...
Cmd.prototype.upload = function() {
  ...
  .description('upload your dapp to a decentralized storage. possible options: ipfs, swarm (e.g workshops upload swarm)')
...
Cmd.prototype.otherCommands = function() {
  ...
  .action(function(env){
    ...
    console.log("type workshops --help to see the available commands");
    process.exit(0);
  });
};
