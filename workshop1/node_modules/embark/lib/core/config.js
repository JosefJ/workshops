...
Config.prototype.loadFiles = function(files) {
  ...
  originalFiles.filter(function(file) {
    ...
    if (file === 'embark.js') {
      ...
      readFiles.push({filename: 'embark.js', content: fs.readFileSync(fs.embarkPath("js/build/workshops.bundle.js")).toString(), path: fs.embarkPath("js/build/workshops.bundle.js")});
    }
  });
