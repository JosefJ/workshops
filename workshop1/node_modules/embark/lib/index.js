...
var Embark = {
  ...
  run: function(options) {
    ...
    async.parallel([
      ...
      if (err) {
        ...
        engine.logger.info("Looking for documentation? you can find it at ".cyan + "http://workshops.readthedocs.io/".green.underline);
  ...
  upload: function(platform) {
    if (platform === 'ipfs') {
      ...
      console.log('try "workshops upload ipfs" or "workshops upload swarm"'.green);
    }
  }
