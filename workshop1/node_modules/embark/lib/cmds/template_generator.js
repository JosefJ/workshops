...
TemplateGenerator.prototype.generate = function(destinationFolder, name) {
  ...
  if (name === 'embark_demo') {
    ...
    console.log('-> '.green + 'workshops blockchain'.bold.cyan + ' or '.green + 'workshops simulator'.bold.cyan);
    console.log('open another console in the same directory and run'.green);
    console.log('-> '.green + 'workshops run'.bold.cyan);
    console.log('For more info go to http://github.com/iurimatias/workshops-framework'.green);
  }
};
